...
import { useGetCommissionPullDataQuery } from "@/redux/api/dashboardApi";
...
export function CommissionRadialChart() {
  ...
  const commissionData = {
    ...
    total: apiData?.data?.totalCommission || 0,
    percentage: apiData?.data?.collectionPercentage || 0,
  };
  const radius = 85;
  ...
  const strokeDashoffset =
    circumference - (commissionData.percentage / 100) * circumference;
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between gap-8">
                ...
                <span className=" font-semibold text-foreground">
                  ${commissionData.paid.toLocaleString()}
                </span>
              </div>
              <div className="flex items-center justify-between gap-8">
                <div className="flex items-center gap-2">
                ...
                <span className=" font-semibold text-foreground">
                  ${commissionData.pending.toLocaleString()}
                </span>
              </div>
